...
class BreakupModel:
    ...
    def simulate_collision(
        ...
        # In reality, Delta-V depends heavily on the Area-to-Mass (A/m) ratio of the fragment.
        # NASA SBM uses a bi-modal normal distribution for log10(Delta-V).
        # We simplify here by generating a log-normal spread of velocities radiating 
        # spherically from the center of mass velocity.
        
        # Mean delta-v varies, but typically ranges from 10 m/s to 1 km/s depending on size.
        # We use a log-normal distribution centered around 0.1 km/s (100 m/s) with wide variance.
        mu_log_dv = np.log(0.1) 
        sigma_log_dv = 1.0
