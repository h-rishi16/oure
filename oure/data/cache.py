...
class CacheManager:
    ...
    def get_risk_history(
        self, primary_id: str, secondary_id: str, limit: int = 100
    ...
    def get_tle(
        ...
        return TLERecord(
            ...
            inclination_deg=row[6],
            raan_deg=row[7],
            eccentricity=row[8],
            arg_perigee_deg=row[9],
            mean_anomaly_deg=row[10],
            mean_motion_rev_per_day=row[11],
            bstar=row[12],
        )
